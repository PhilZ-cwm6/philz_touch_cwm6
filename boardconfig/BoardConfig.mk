...
#Motorola Moto G: GSM (xt1032), Dual Sim (xt1033), Retail US (xt1034)
else ifneq ($(filter $(TARGET_PRODUCT),cm_xt1032 cm_xt1033 cm_xt1034),)
    TARGET_COMMON_NAME := Moto G ($(TARGET_PRODUCT))
    BRIGHTNESS_SYS_FILE := "/sys/class/leds/lcd-backlight/brightness"
