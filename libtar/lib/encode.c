...
th_set_path(TAR *t, const char *pathname)
{
	...
	else if (pathname_len >= T_NAMELEN)
	{
		...
		/* any short name for all formats, or classic (--format=v7) tar format (99 chars max) */
